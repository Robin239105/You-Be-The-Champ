...
import { LayoutDashboard, Package, Tag, ShoppingCart, Ticket, Settings, Users, ArrowLeft, FileText, Award } from 'lucide-react';
...
const AdminSidebar = () => {
  ...
  const menuItems = [
    ...
    { label: 'Affiliates', path: '/admin/affiliates', icon: Award },
