  ...
  return (
    <div className="bg-black min-h-screen">
      ...
      <div className="pt-40 pb-20 px-8 text-center bg-surface relative overflow-hidden">
        ...
        <p className="mt-4 text-ivory/60 font-raleway uppercase tracking-[4px] text-xs relative z-10">
      ...
      <div className="max-w-7xl mx-auto px-8 py-16 flex flex-col lg:flex-row gap-12">
          ...
          <div className="pt-8 border-t border-gold/10">
            <div className="bg-gold/5 p-6 border border-gold/10">
              <p className="text-[10px] text-gold font-cinzel tracking-widest uppercase leading-relaxed text-center">
                All our rings are crafted from premium zinc alloy with quadruple 18K gold plating and AAA+ CZ stones.
              </p>
            </div>
          </div>
        </aside>
        ...
        <main className="flex-1">
          <div className="flex flex-col md:flex-row md:items-center justify-between mb-12 border-b border-gold/10 pb-6 gap-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-8 min-h-[600px]">
              ...
              <div className="flex items-center gap-2">
                {Array.from({ length: totalPages }).map((_, i) => {
                  ...
                  if (
                    ...
                    return <span key={pageNum} className="text-gold/30">...</span>;
                  }
                  return null;
                })}
              </div>
