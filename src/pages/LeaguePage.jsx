...
const NFLLogo = () => (
  <img src="/NFL Logo.png" alt="NFL" className="w-16 h-16 object-contain" />
);

const NBALogo = () => (
  <img src="/NBA Logo.png" alt="NBA" className="w-16 h-16 object-contain" />
);

const MLBLogo = () => (
  <img src="/MLB Logo.png" alt="MLB" className="w-16 h-16 object-contain" />
);

const NHLLogo = () => (
  <img src="/NHL Logo.png" alt="NHL" className="w-16 h-16 object-contain" />
);
