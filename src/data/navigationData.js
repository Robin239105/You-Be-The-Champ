export const navigationData = [
  ...
  // 1. ALL TIME GREATS — Player Grid
  {
    ...
    layout: "players",
    players: [
      { name: "Tom Brady", sport: "NFL", path: "All Time Greats > Tom Brady (NFL)", photo: "https://images.weserv.nl/?url=upload.wikimedia.org/wikipedia/commons/7/7c/Tom_Brady_2021.jpg&w=300&h=400&fit=cover&a=top" },
      { name: "Michael Jordan", sport: "NBA", path: "All Time Greats > Michael Jordan (NBA)", photo: "https://images.weserv.nl/?url=upload.wikimedia.org/wikipedia/commons/a/ae/Michael_Jordan_in_2014.jpg&w=300&h=400&fit=cover&a=top" },
      { name: "Kobe Bryant", sport: "NBA", path: "All Time Greats > Kobe Bryant (NBA)", photo: "https://images.weserv.nl/?url=upload.wikimedia.org/wikipedia/commons/6/6e/Kobe_Bryant_2014.jpg&w=300&h=400&fit=cover&a=top" },
      { name: "LeBron James", sport: "NBA", path: "All Time Greats > Lebron James (NBA)", photo: "https://images.weserv.nl/?url=upload.wikimedia.org/wikipedia/commons/2/25/LeBron_James_Lakers.jpg&w=300&h=400&fit=cover&a=top" },
      { name: "Babe Ruth", sport: "MLB", path: "All Time Greats > Babe Ruth (MLB)", photo: "https://images.weserv.nl/?url=upload.wikimedia.org/wikipedia/commons/1/13/Babe_Ruth2.jpg&w=300&h=400&fit=cover&a=top" },
      { name: "Wayne Gretzky", sport: "NHL", path: "All Time Greats > Wayne Gretzsky (NHL)", photo: "https://images.weserv.nl/?url=upload.wikimedia.org/wikipedia/commons/5/5c/Wayne_Gretzky_1997.jpg&w=300&h=400&fit=cover&a=top" },
      { name: "Joe Montana", sport: "NFL", path: "All Time Greats > Joe Montana (NFL)", photo: "https://images.weserv.nl/?url=upload.wikimedia.org/wikipedia/commons/8/8d/Joe_Montana_1994.jpg&w=300&h=400&fit=cover&a=top" },
      { name: "Magic Johnson", sport: "NBA", path: "All Time Greats > Magic Johnson (NBA)", photo: "https://images.weserv.nl/?url=upload.wikimedia.org/wikipedia/commons/3/3a/Magic_Johnson_2014.jpg&w=300&h=400&fit=cover&a=top" },
      { name: "Derek Jeter", sport: "MLB", path: "All Time Greats > Derek Jeter (MLB)", photo: "https://images.weserv.nl/?url=upload.wikimedia.org/wikipedia/commons/2/2c/Derek_Jeter_2011.jpg&w=300&h=400&fit=cover&a=top" },
      { name: "Sidney Crosby", sport: "NHL", path: "All Time Greats > Sidney Crosby (NHL)", photo: "https://images.weserv.nl/?url=upload.wikimedia.org/wikipedia/commons/0/02/Sidney_Crosby_2019.jpg&w=300&h=400&fit=cover&a=top" },
      { name: "Jerry Rice", sport: "NFL", path: "All Time Greats > Jerry Rice (NFL)", photo: "https://images.weserv.nl/?url=upload.wikimedia.org/wikipedia/commons/4/4b/Jerry_Rice_2009.jpg&w=300&h=400&fit=cover&a=top" },
      { name: "Larry Bird", sport: "NBA", path: "All Time Greats > Larry Bird (NBA)", photo: "https://images.weserv.nl/?url=upload.wikimedia.org/wikipedia/commons/5/56/Larry_Bird_2004.jpg&w=300&h=400&fit=cover&a=top" },
      { name: "Mickey Mantle", sport: "MLB", path: "All Time Greats > Mickey Mantle (MLB)", photo: "https://images.weserv.nl/?url=upload.wikimedia.org/wikipedia/commons/0/0c/Mickey_Mantle_1957.jpg&w=300&h=400&fit=cover&a=top" },
      { name: "Mario Lemieux", sport: "NHL", path: "All Time Greats > Mario Lemieux (NHL)", photo: "https://images.weserv.nl/?url=upload.wikimedia.org/wikipedia/commons/1/1e/Mario_Lemieux_2006.jpg&w=300&h=400&fit=cover&a=top" },
      { name: "Peyton Manning", sport: "NFL", path: "All Time Greats > Peyton Manning (NFL)", photo: "https://images.weserv.nl/?url=upload.wikimedia.org/wikipedia/commons/7/7a/Peyton_Manning_2015.jpg&w=300&h=400&fit=cover&a=top" },
      { name: "Steph Curry", sport: "NBA", path: "All Time Greats > Steph Curry (NBA)", photo: "https://images.weserv.nl/?url=upload.wikimedia.org/wikipedia/commons/8/8a/Stephen_Curry_2016.jpg&w=300&h=400&fit=cover&a=top" },
      { name: "Hank Aaron", sport: "MLB", path: "All Time Greats > Hank Aaron (MLB)", photo: "https://images.weserv.nl/?url=upload.wikimedia.org/wikipedia/commons/3/37/Hank_Aaron_1960.jpg&w=300&h=400&fit=cover&a=top" },
      { name: "Gordie Howe", sport: "NHL", path: "All Time Greats > Gordie Howe (NHL)", photo: "https://images.weserv.nl/?url=upload.wikimedia.org/wikipedia/commons/e/e0/Gordie_Howe_1966.jpg&w=300&h=400&fit=cover&a=top" },
      { name: "Patrick Mahomes", sport: "NFL", path: "All Time Greats > Patrick Mahomes (NFL)", photo: "https://images.weserv.nl/?url=upload.wikimedia.org/wikipedia/commons/5/5a/Patrick_Mahomes_2021.jpg&w=300&h=400&fit=cover&a=top" },
      { name: "Kareem Abdul-Jabbar", sport: "NBA", path: "All Time Greats > Kareem Abdul-Jabbar (NBA)", photo: "https://images.weserv.nl/?url=upload.wikimedia.org/wikipedia/commons/8/82/Kareem_Abdul-Jabbar_2014.jpg&w=300&h=400&fit=cover&a=top" },
    ]
  },
